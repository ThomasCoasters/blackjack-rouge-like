...
window.all_upgrades = {
    ...
    "permanent_upgrades": [
    {"suit": "permanent_upgrade_row_1", "value": "increase_max_total_value", "hover_name": "power of the vessel", "hover_text": "'Sealed away it's power grows.' permanent upgrade: increases the maximum total value by 2", "effect": increase_max_total_value},
    {"suit": "permanent_upgrade_row_1", "value": "increase_max_total_value_but_less_discards", "hover_name": "fragile strength", "hover_text": "'Great strength but great risks.' permanent upgrade: increases the maximum total value by 5 but have 1 less discard", "effect": increase_max_total_value_but_less_discards},
    {"suit": "permanent_upgrade_row_1", "value": "increase_blackjack_bonus", "hover_name": "blue SOUL focus", "hover_text": "'patience brings better score.' permanent upgrade: increases the blackjack bonus multiplier by 0.5", "effect": increase_blackjack_bonus},
    ...
    {"suit": "permanent_upgrade_row_1", "value": "increase_hands_but_negative_blackjack", "hover_name": "Jester's chaos", "hover_text": "'Chaos, Chaos! more turns less mercy!' permanent upgrade: increases number of hands by 1 but decrease blackjack multiplier to -0.5 (losing points for blackjack)", "effect": increase_hands_but_negative_blackjack},
    {"suit": "permanent_upgrade_row_1", "value": "increase_hands_but_less_discards", "hover_name": "drifter's cloak", "hover_text": "'Go further, but remove what brings you down' permanent upgrade: increases number of hands by 1 but have 1 less discard", "effect": increase_hands_but_less_discards},
    {"suit": "permanent_upgrade_row_1", "value": "increase_discards_but_less_hands", "hover_name": "silken strategy", "hover_text": "'Embrace the silk, but lose your grip.' permanent upgrade: increases number of discards by 1 but have 1 less hand", "effect": increase_discards_but_less_hands},
    {"suit": "permanent_upgrade_row_1", "value": "increase_discards_but_draw_more", "hover_name": "soul overflow", "hover_text": "'Embrace the chaos.' permanent upgrade: increases number of discards by 6 but draw 5 more cards at the beginning", "effect": increase_discards_but_draw_more},
    ...
    {"suit": "permanent_upgrade_row_1", "value": "gain_discard_each_hand", "hover_name": "'Make it turn based'", "hover_text": "permanent upgrade: gain a discard every round but start with 2 less discards", "effect": gain_discard_each_hand},
    {"suit": "permanent_upgrade_row_1", "value": "less_hands_but_reuse_face_cards", "hover_name": "Mask of a performer", "hover_text": "'the show must go on.' permanent upgrade: lose 1 hand but can reuse face cards", "effect": less_hands_but_reuse_face_cards},
    {"suit": "permanent_upgrade_row_1", "value": "less_hands_and_discards_but_retrigger_face_cards", "hover_name": "void's echo", "hover_text": "'From the abyss you will gain strength at a great cost.' permanent upgrade: lose 1 hand and 1 discard but can retrigger face cards", "effect": less_hands_and_discards_but_retrigger_face_cards},
    ],
