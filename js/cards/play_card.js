...
var available_cards = [
  ...
  {"suit": "hearts", "value": "ace", "reusing": true, "hover_name": "reusable waste", "hover_text": "card that can be reused with no suit but a value of 5"}, {"suit": "hearts", "value": "ace", "reusing": true, "hover_name": "reusable waste", "hover_text": "card that can be reused with no suit but a value of 5"}, {"suit": "hearts", "value": "ace", "reusing": true, "hover_name": "reusable waste", "hover_text": "card that can be reused with no suit but a value of 5"}, {"suit": "hearts", "value": "ace", "reusing": true, "hover_name": "reusable waste", "hover_text": "card that can be reused with no suit but a value of 5"}, {"suit": "hearts", "value": "ace", "reusing": true, "hover_name": "reusable waste", "hover_text": "card that can be reused with no suit but a value of 5"}, {"suit": "hearts", "value": "ace", "reusing": true, "hover_name": "reusable waste", "hover_text": "card that can be reused with no suit but a value of 5"}
  // {"suit": "special_1", "value": "1", "reusing": true, "hover_name": "reusable waste", "hover_text": "card that can be reused with no suit but a value of 5"}, {"suit": "hearts", "value": "ace", "hover_name": "ace of hearts", "hover_text": "hearts card with an value of 1 or 11", "special": ace_special, "special_location": "total value"}
];
