...
window.all_upgrades = {
    ...
    "permanent_upgrades": [
    {"suit": "permanent_upgrade_row_1", "value": "increase_max_total_value", "hover_name": "increase max total value", "hover_text": "permanent upgrade: increases the maximum total value by 2", "effect": increase_max_total_value},
    {"suit": "permanent_upgrade_row_1", "value": "increase_max_total_value_but_less_discards", "hover_name": "increase max total value", "hover_text": "permanent upgrade: increases the maximum total value by 5 but have 1 less discard", "effect": increase_max_total_value_but_less_discards},
    {"suit": "permanent_upgrade_row_1", "value": "increase_blackjack_bonus", "hover_name": "increase blackjack bonus", "hover_text": "permanent upgrade: increases the blackjack bonus multiplier by 0.5", "effect": increase_blackjack_bonus},
    {"suit": "permanent_upgrade_row_1", "value": "extra_upgrade_slot_but_decrease_max_total_value", "hover_name": "extra slot", "hover_text": "permanent upgrade: increases the amount of upgrades you can choose from by 1 but maximum total value decreases by 3", "effect": extra_upgrade_slot_but_decrease_max_total_value},
    {"suit": "permanent_upgrade_row_1", "value": "extra_upgrade_slot_but_decrease_hands", "hover_name": "extra slot", "hover_text": "permanent upgrade: increases the amount of upgrades you can choose from by 1 but maximum number of hands decreases by 1", "effect": extra_upgrade_slot_but_decrease_hands},
    {"suit": "permanent_upgrade_row_1", "value": "increase_hands_but_negative_blackjack", "hover_name": "extra hands", "hover_text": "permanent upgrade: increases number of hands by 1 but decrease blackjack multiplier to -0.5 (losing points for blackjack)", "effect": increase_hands_but_negative_blackjack},
    {"suit": "permanent_upgrade_row_1", "value": "increase_hands_but_less_discards", "hover_name": "trade", "hover_text": "permanent upgrade: increases number of hands by 1 but have 1 less discard", "effect": increase_hands_but_less_discards},
    {"suit": "permanent_upgrade_row_1", "value": "increase_discards_but_less_hands", "hover_name": "trade", "hover_text": "permanent upgrade: increases number of discards by 1 but have 1 less hand", "effect": increase_discards_but_less_hands},
    {"suit": "permanent_upgrade_row_1", "value": "increase_discards_but_draw_more", "hover_name": "test your luck", "hover_text": "permanent upgrade: increases number of discards by 6 but draw 5 more cards at the beginning", "effect": increase_discards_but_draw_more},
    {"suit": "permanent_upgrade_row_1", "value": "1_hand_now", "hover_name": "glass hand", "hover_text": "permanent upgrade: this round you have 1 hand but after this round you will get 2", "effect": hand_now_1_later_2},
    {"suit": "permanent_upgrade_row_1", "value": "gain_discard_each_hand", "hover_name": "tactician", "hover_text": "permanent upgrade: gain a discard every round but start with 2 less discards", "effect": gain_discard_each_hand},
    {"suit": "permanent_upgrade_row_1", "value": "less_hands_but_reuse_face_cards", "hover_name": "faces galore", "hover_text": "permanent upgrade: lose 1 hand but can reuse face cards", "effect": less_hands_but_reuse_face_cards},
    {"suit": "permanent_upgrade_row_1", "value": "less_hands_and_discards_but_retrigger_face_cards", "hover_name": "faces galore", "hover_text": "permanent upgrade: lose 1 hand and 1 discard but can retrigger face cards", "effect": less_hands_and_discards_but_retrigger_face_cards},
],
