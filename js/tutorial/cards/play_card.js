...
function addCard() {
  ...
  if (0 !== -1) {
    available_cards.splice(0, 1); // removes 1 card
  }
  ...
  create_new_card(card, document.getElementById("cardsContainer"), "card");
}
